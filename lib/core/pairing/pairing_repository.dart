...
class PairingRepository {
  Future<void> sendPairingRequest([dynamic a1, dynamic a2, dynamic a3, dynamic a4, dynamic a5]) async {}
  Future<dynamic> confirmPairing([dynamic a1, dynamic a2, dynamic a3, dynamic a4, dynamic a5]) async => null;
